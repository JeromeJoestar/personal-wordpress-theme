...
function portfolio_theme_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'portfolio_theme' ),
	) );
...
function portfolio_theme_scripts() {
	wp_enqueue_style( 'portfolio_theme-style', get_stylesheet_uri() );

	wp_enqueue_script( 'portfolio_theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'portfolio_theme-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
